...
export const FRED_SERIES = [
  ...
  // Realized inflation by region. FRED's UK CPI feeds (OECD) are all
  // discontinued, so UK CPI comes from the ONS API directly; Japan has no
  // live free monthly CPI feed at all.
  ...
  { id: 'UKCPI_D7G7', source: 'ons',
    ...
    name: 'UK CPI', transform: 'level', unit: '% y/y', freq: 'm' },
