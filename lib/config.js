...
// Macro series from free public endpoints (FRED fredgraph.csv by default; the
// source field switches to the ONS / ECB / BoE fetchers in lib/fred.js).
// freq drives how many observations back "3m/6m change" looks (d/w/m/q);
// topic groups related series together in the Macro tab.
export const FRED_SERIES = [
  { id: 'CPIAUCSL',     name: 'CPI (headline)',        transform: 'yoy', unit: '% y/y', freq: 'm', topic: 'Inflation' },
  { id: 'CPILFESL',     name: 'CPI (core)',            transform: 'yoy', unit: '% y/y', freq: 'm', topic: 'Inflation' },
  { id: 'CP0000EZ19M086NEST', name: 'Euro Area HICP',  transform: 'yoy', unit: '% y/y', freq: 'm', topic: 'Inflation' },
  { id: 'UKCPI_D7G7', source: 'ons',
    onsPath: 'economy/inflationandpriceindices/timeseries/d7g7/mm23',
    name: 'UK CPI', transform: 'level', unit: '% y/y', freq: 'm', topic: 'Inflation' },
  // Market-implied inflation expectations: US TIPS breakevens (FRED),
  // euro-area inflation-linked swaps (ECB), UK gilt-implied (BoE).
  // Japan has no free JGBi breakeven feed.
  { id: 'T5YIE',        name: 'US 5y Breakeven',       transform: 'level', unit: '%', freq: 'd', topic: 'Inflation expectations' },
  { id: 'T10YIE',       name: 'US 10y Breakeven',      transform: 'level', unit: '%', freq: 'd', topic: 'Inflation expectations' },
  { id: 'T5YIFR',       name: 'US 5y5y Forward',       transform: 'level', unit: '%', freq: 'd', topic: 'Inflation expectations' },
  { id: 'EZBE5', source: 'ecb', ecbKey: 'M.U2.EUR.4F.BB.U2_5Y.YLD',
    name: 'Euro 5y Inflation Swap', transform: 'level', unit: '%', freq: 'm', topic: 'Inflation expectations' },
  { id: 'EZBE10', source: 'ecb', ecbKey: 'M.U2.EUR.4F.BB.U2_10Y.YLD',
    name: 'Euro 10y Inflation Swap', transform: 'level', unit: '%', freq: 'm', topic: 'Inflation expectations' },
  // IADB tenor convention: S/M/L = 5/10/20 year; IIF = implied inflation
  // forward. Daily (IUD) tried first, monthly (IUM) as fallback.
  { id: 'UKBE5', source: 'boe',
    boeCodes: [{ code: 'IUDSIIF', freq: 'd' }, { code: 'IUMSIIF', freq: 'm' }],
    name: 'UK 5y Implied Inflation', transform: 'level', unit: '%', freq: 'd', topic: 'Inflation expectations' },
  { id: 'UKBE10', source: 'boe',
    boeCodes: [{ code: 'IUDMIIF', freq: 'd' }, { code: 'IUMMIIF', freq: 'm' }],
    name: 'UK 10y Implied Inflation', transform: 'level', unit: '%', freq: 'd', topic: 'Inflation expectations' },
  // Growth & labor
  { id: 'UNRATE',       name: 'Unemployment Rate',     transform: 'level', unit: '%', freq: 'm', topic: 'Growth & labor' },
  { id: 'PAYEMS',       name: 'Nonfarm Payrolls',      transform: 'mom_k', unit: 'k m/m', freq: 'm', topic: 'Growth & labor' },
  { id: 'ICSA',         name: 'Initial Jobless Claims', transform: 'level_k', unit: 'k/wk', freq: 'w', topic: 'Growth & labor' },
  { id: 'INDPRO',       name: 'Industrial Production', transform: 'yoy', unit: '% y/y', freq: 'm', topic: 'Growth & labor' },
  { id: 'UMCSENT',      name: 'Consumer Sentiment',    transform: 'level', unit: 'idx', freq: 'm', topic: 'Growth & labor' },
  // Central-bank policy stance. The ECB deposit rate comes from the ECB
  // itself (FRED's mirror lags); SONIA and the BoJ call rate track their
  // policy rates within a few bp.
  { id: 'FEDFUNDS',     name: 'Fed Funds Rate',        transform: 'level', unit: '%', freq: 'm', topic: 'Policy rates' },
  { id: 'ECBDFR', source: 'ecb', ecbDataset: 'FM', ecbKey: 'D.U2.EUR.4F.KR.DFR.LEV',
    name: 'ECB Deposit Rate', transform: 'level', unit: '%', freq: 'd', topic: 'Policy rates' },
  { id: 'IUDSOIA',      name: 'BoE SONIA Rate',        transform: 'level', unit: '%', freq: 'd', topic: 'Policy rates' },
  { id: 'IRSTCI01JPM156N', name: 'BoJ Overnight Call Rate', transform: 'level', unit: '%', freq: 'm', topic: 'Policy rates' },
  // Rates & credit. The euro 1y AAA-curve forward and 1y JGB yield also feed
  // the per-bank implied policy direction.
  { id: 'T10Y2Y',       name: '10Y-2Y Curve',          transform: 'level', unit: 'pp', freq: 'd', topic: 'Rates & credit' },
  { id: 'BAMLH0A0HYM2', name: 'HY Credit Spread (OAS)', transform: 'level', unit: 'pp', freq: 'd', topic: 'Rates & credit' },
  { id: 'EZIF1Y', source: 'ecb', ecbDataset: 'YC', ecbKey: 'B.U2.EUR.4F.G_N_A.SV_C_YM.IF_1Y',
    name: 'Euro 1y Forward (AAA curve)', transform: 'level', unit: '%', freq: 'd', topic: 'Rates & credit' },
  { id: 'JGB1Y', source: 'mof', mofTenor: '1Y',
    name: 'Japan 1y JGB Yield', transform: 'level', unit: '%', freq: 'd', topic: 'Rates & credit' }
];
