...
export const GROUPS = { REGIONS, SECTORS, STYLES, BONDS, COMMODITIES, FX, RISK };
...
export const FRED_SERIES = [
  { id: 'CPIAUCSL',     name: 'CPI (headline)',        transform: 'yoy', unit: '% y/y' },
  { id: 'CPILFESL',     name: 'CPI (core)',            transform: 'yoy', unit: '% y/y' },
  { id: 'UNRATE',       name: 'Unemployment Rate',     transform: 'level', unit: '%' },
  { id: 'PAYEMS',       name: 'Nonfarm Payrolls',      transform: 'mom_k', unit: 'k m/m' },
  { id: 'FEDFUNDS',     name: 'Fed Funds Rate',        transform: 'level', unit: '%' },
  { id: 'T10Y2Y',       name: '10Y-2Y Curve',          transform: 'level', unit: 'pp' },
  { id: 'BAMLH0A0HYM2', name: 'HY Credit Spread (OAS)', transform: 'level', unit: 'pp' },
  { id: 'UMCSENT',      name: 'Consumer Sentiment',    transform: 'level', unit: 'idx' }
];
